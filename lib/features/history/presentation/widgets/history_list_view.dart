...
class HistoryListView extends StatelessWidget {
  ...
  const HistoryListView({super.key, required this.entries, required this.onDelete});
        ...
        return Dismissible(
          ...
          onDismissed: (direction) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('${entry.title} removed from history')),
            );
          },
          ...
          child: Card(
            ...
            child: InkWell(
              onTap: () {
                context.push('/comic/${Uri.encodeComponent(entry.id)}');
              },
              child: Padding(
